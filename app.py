...
위 예시의 어조·밀도·구체성을 참고하되 절대 그대로 쓰지 말 것. 강사와 과목에 맞게 완전히 새로운 문구로 작성.
...
"reviews":[["지금도 쓸 것 같은 생생한 수강생 인용문 50-70자, 구체적 점수·방법 언급","이름","변화뱃지"],["50-70자 인용문","이름","뱃지"],["50-70자 인용문","이름","뱃지"]]
